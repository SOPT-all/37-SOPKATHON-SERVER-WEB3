...
public class DiaryPageResponseDto {
    ...
    @Builder
    private DiaryPageResponseDto(List<DiaryResponseDto> diaries, Long nextCursor, boolean hasNext) {
        this.diaries = diaries;
        this.nextCursor = nextCursor;
        this.hasNext = hasNext;
    }

    public static DiaryPageResponseDto of(List<DiaryResponseDto> diaries, Long nextCursor, boolean hasNext) {
